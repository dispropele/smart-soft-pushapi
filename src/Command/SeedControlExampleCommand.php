...
class SeedControlExampleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->section('Клиенты...');
        $clientData = [
            ['Иванов Иван Иванович','123456','4510','89001112233','г. Тольятти, ул. Мира, 1'],
            ['Петров Петр Петрович','654321','4511','89004445566','г. Тольятти, ул. Победы, 15'],
            ['Сидорова Анна Павловна','789012','4612','89117778899','г. Тольятти, ул. Юбилейная, 2'],
            ['Кузнецов Олег Игоревич','345678','5014','89200001122','г. Тольятти, ул. Революционная, 5'],
            ['Смирнова Елена Викторовна','556677','4510','89503334455','г. Тольятти, ул. 70 лет Октября, 10'],
            ['Васильев Сергей Андреевич','112233','4508','89601234567','г. Тольятти, ул. Дзержинского, 3'],
            ['Морозова Ольга Сергеевна','998877','4515','89059876543','г. Тольятти, ул. Баныкина, 8'],
            ['Павлов Игорь Владимирович','443322','6010','89165554433','г. Тольятти, ул. Автостроителей, 12'],
            ['Соколов Максим Юрьевич','224466','4511','89031110022','г. Тольятти, ул. Тополиная, 21'],
            ['Федорова Дарья Алексеевна','775533','4614','89092223344','г. Тольятти, ул. Фрунзе, 4'],
            ['Попов Андрей Николаевич','884422','4510','89815556677','г. Тольятти, ул. Ленина, 101'],
            ['Семенова Инна Игоревна','339911','5012','89214443322','г. Тольятти, ул. Лизы Чайкиной, 45'],
            ['Волков Артем Дмитриевич','121212','4518','89008889900','г. Тольятти, ул. Ворошилова, 11'],
            ['Борисова Яна Олеговна','343434','4509','89110001122','г. Тольятти, ул. Гидротехническая, 5'],
            ['Макаров Денис Петрович','565656','4610','89057778899','г. Тольятти, Приморский б-р, 19'],
        ];
        $clients = [];
        ...
        $ticketData = [
            ['ЛБ-001','2026-04-01','Иванов Иван Иванович','Стандартный','25000.00','closed',true],
            ['ЛБ-002','2026-04-02','Петров Петр Петрович','Стандартный','12000.00','open',false],
            ['ЛБ-003','2026-04-05','Сидорова Анна Павловна','Льготный','45000.00','open',false],
            ['ЛБ-004','2026-04-07','Смирнова Елена Викторовна','Стандартный','8500.00','expired',true],
            ['ЛБ-005','2026-04-10','Васильев Сергей Андреевич','VIP','180000.00','open',false],
            ['ЛБ-006','2026-04-12','Федорова Дарья Алексеевна','Стандартный','32000.00','closed',true],
            ['ЛБ-007','2026-04-15','Семенова Инна Игоревна','Льготный','6000.00','open',false],
            ['ЛБ-008','2026-04-18','Макаров Денис Петрович','Стандартный','19500.00','expired',true],
            ['ЛБ-009','2026-04-20','Кузнецов Олег Игоревич','Срочный','60000.00','open',false],
            ['ЛБ-010','2026-04-22','Павлов Игорь Владимирович','VIP','95000.00','open',false],
        ];
        $tickets = [];
