...
class PledgedItem
{
    ...
    /** Вес лома (чистый металл без вставок) */
    #[ORM\Column(type: Types::DECIMAL, precision: 10, scale: 2, nullable: true)]
    private ?string $scrapWeight = null;

    /** Оценочная стоимость (при залоге) */
    #[ORM\Column(type: Types::DECIMAL, precision: 12, scale: 2, nullable: true)]
    private ?string $estimatedValue = null;

    /** Сумма выкупа (сколько клиент должен заплатить для возврата) */
    #[ORM\Column(type: Types::DECIMAL, precision: 12, scale: 2, nullable: true)]
    ...
    /** Цена продажи (при реализации через витрину) */
    #[ORM\Column(type: Types::DECIMAL, precision: 12, scale: 2, nullable: true)]
    ...
    /** Дата публикации на витрине (заполняется при переводе в for_sale) */
    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
